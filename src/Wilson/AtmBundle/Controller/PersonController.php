...
use Wilson\AtmBundle\Form\PersonType;
...
class PersonController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('WilsonAtmBundle:Person')->findAll();

        return new Response($this->get('serializer')->serialize($entities, 'json'));
    }
    /**
     ...
     * @Method("POST")
     * @Template("WilsonAtmBundle:Person:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('WilsonAtmBundle:Person')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("WilsonAtmBundle:Person:edit.html.twig")
     */
